...
head:
  - tag: link
    attrs:
      rel: canonical
      href: "https://www.wissen-und-werkzeug.de/wiki/service-design-phase-entwickeln/"
  - tag: script
    attrs:
...
### 1. Ideenorientiertes Denken (Divergenz)
...
### 2. Lösungsorientiertes Denken (Konvergenz)
