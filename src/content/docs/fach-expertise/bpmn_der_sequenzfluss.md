...
- **[BPMN Aufgaben und Teilprozesse](/wiki/fach-expertise/bpmn_aufgaben_und_teilprozesse/)***Kontext:* Erläutert die Knotenpunkte (Aufgaben), die durch den Sequenzfluss verbunden werden.
- **[BPMN Pools und Schwimmbahnen](/wiki/fach-expertise/bpmn_pools_und_schwimmbahnen/)***Kontext:* Definiert die Container-Grenzen, an denen der Sequenzfluss stoppen muss.
- **[BPMN Kollaboration & Externe Beteiligte](/wiki/fach-expertise/bpmn_kollaboration_externe_beteiligte/)***Kontext:* Erklärt den Nachrichtenfluss, der im Gegensatz zum Sequenzfluss Poolgrenzen überschreiten darf.