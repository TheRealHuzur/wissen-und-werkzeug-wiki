...
- **[BPMN Der Sequenzfluss](/wiki/fach-expertise/bpmn_der_sequenzfluss/)***Kontext:* Erläutert die Verbindung von Aktivitäten und die zwingende Nutzung von Gateways.
- **[BPMN Pools und Schwimmbahnen](/wiki/fach-expertise/bpmn_pools_und_schwimmbahnen/)***Kontext:* Ergänzt das "Was" (Aktivität) um das "Wer" (Verantwortlichkeit).
