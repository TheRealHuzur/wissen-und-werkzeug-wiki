...
- **[Phase Verstehen (Erfassen & Analysieren)](/wiki/fach-expertise/phase_verstehen_erfassen_analysieren/)** 
- *Kontext:* Der erste Hauptknoten (Das Labor).
- **[Phase Gestalten (Soll-Konzeption)](/wiki/fach-expertise/phase_gestalten_soll_konzeption/)** 
- *Kontext:* Der zweite Hauptknoten (Das Atelier).
- **[Phase Umsetzen (Change Management)](/wiki/fach-expertise/phase_umsetzen_change_management/)** 
- *Kontext:* Der dritte Hauptknoten (Die Werkstatt).
- **[Der Kontinuierliche Verbesserungsprozess (KVP)](/wiki/fach-expertise/prinzip_der_kontinuierliche_verbesserungsprozess_kvp/)
